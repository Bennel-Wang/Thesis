...
log_csv = pd.read_csv('/home/jin/Documents/DARPA2000-LLS_DDOS_2.0.2/phase5.csv', sep=',')
...
xes_exporter.apply(event_log, '/home/jin/Documents/DARPA2000-LLS_DDOS_2.0.2/phase5.xes')

log = xes_importer.apply('/home/jin/Documents/DARPA2000-LLS_DDOS_2.0.2/phase5.xes')
